...
//@version=5
strategy("B2", overlay=true, margin_long=100, margin_short=100, process_orders_on_close = true)
...
//CONDITIONS
longCondition = (SMA1> SMA14) and(SMA11> SMA144) and (low<= S2) and ((currentHour <5 and currentHour >= 1) or (currentHour <10 and currentHour >= 6))
if (longCondition and canTrade)
    strategy.entry("Long", strategy.long, when= longCondition)
    canTrade := false
        //shortCondition
shortCondition = (SMA1< SMA14) and (SMA11< SMA144) and (high>= R2) and ((currentHour <5 and currentHour >= 1) or (currentHour <10 and currentHour >= 6))
...
plot(SMA11, title="sma11", color = color.rgb(98, 206, 248))
plot(SMA144, title="sma144", color = color.rgb(253, 103, 10))
